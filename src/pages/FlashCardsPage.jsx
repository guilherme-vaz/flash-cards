...
export default function FlashCardsPage() {
  ...
  function _toggleShowTitleOrDescription(showTitle) {
     ...
     */
    // prettier-ignore
    const updatedStudyCards = [...studyCards].map(card => ({...card, showTitle}));
   ...
   */
  if (error) {
    mainJsx = <Error padding="p-2">{error}</Error>;
  }
        ...
        <Tabs selectedIndex={currentTab} onSelect={handleChangeTab}>
          ...
          <TabPanel>
            <div className="text-center mb-4">
              <Button textColor="text-black" onButtonClick={handleShuffle}>
                Embaralhar cards
              </Button>
            </div>
